...
\ifx{\Sexpr{nrow(highlight_table$highlight)}}0
...
<<eval=TRUE, results="tex", echo=FALSE>>=
if(is.null(som_all$muts_tab || )dim(som_all$muts_tab)[1] == 0) {
