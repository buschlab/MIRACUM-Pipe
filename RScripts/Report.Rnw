...
if (protocol == "SomaticGermline"){
  if (length(helper) == 1){
    tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (exonisch, VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Anzahl CN- Regionen", paste0("Anzahl seltener Keimbahnmutationen (VAF > ", vaf, "%)")), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), as.character(round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0)), paste0(round(x = mut_sig_ana$output$Summary[helper, 3], digits = 2), " %"), paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen"), length(which(as.numeric(gsub(pattern = "%", replacement = "", x = filt_result_gd$table$Variant_Allele_Frequency[-which(is.na(filt_result_gd$table$ExonicFunc.refGene))])) > 10))))
    } else {
      tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (exonisch, VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Anzahl CNV- Regionen", paste0("Anzahl seltener Keimbahnmutationen (VAF > ", vaf, "%)")), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0), "< 1.0%", paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen"), length(which(as.numeric(gsub(pattern = "%", replacement = "", x = filt_result_gd$table$Variant_Allele_Frequency[-which(is.na(filt_result_gd$table$ExonicFunc.refGene))])) > 10))))
    }
} else {
    if (length(helper) == 1){
      tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (exonisch, VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Anzahl CNV Regionen"), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), as.character(round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0)), paste0(round(x = mut_sig_ana$output$Summary[helper, 3], digits = 2), " %"), paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen")))
    } else {
      tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (exonisch, VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Anzahl CNV- Regionen"), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0), "< 1.0%", paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen")))
    }
}
...
#if (protocol == "SomaticGermline"){
#  if (length(helper) == 1){
#    tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Mikrosatelliten Status", "Anzahl CN- Regionen", paste0("Anzahl seltener Keimbahnmutationen (VAF > ", vaf, "%)")), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), as.character(round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0)), paste0(round(x = mut_sig_ana$output$Summary[helper, 3], digits = 2), " %"), as.character(filt_result_td$msi$MSI_status[1]), paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen"), length(which(as.numeric(gsub(pattern = "%", replacement = "", x = filt_result_gd$table$Variant_Allele_Frequency[-which(is.na(filt_result_gd$table$ExonicFunc.refGene))])) > 10))))
#    } else {
#      tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Mikrosatelliten Status", "Anzahl CNV- Regionen", paste0("Anzahl seltener Keimbahnmutationen (VAF > ", vaf, "%)")), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0), "< 1.0%", as.character(filt_result_td$msi$MSI_status[1]), paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen"), length(which(as.numeric(gsub(pattern = "%", replacement = "", x = filt_result_gd$table$Variant_Allele_Frequency[-which(is.na(filt_result_gd$table$ExonicFunc.refGene))])) > 10))))
#    }
#} else {
#    if (length(helper) == 1){
#      tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Mikrosatelliten Status", "Anzahl CNV Regionen"), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), as.character(round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0)), paste0(round(x = mut_sig_ana$output$Summary[helper, 3], digits = 2), " %"), as.character(filt_result_td$msi$MSI_status[1]), paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen")))
#    } else {
#      tmp1 <- data.frame(Eigenschaften = c("Capture Kit", "Abgedeckte Region", paste0("Mutationslast (VAF > ", vaf, "%)"), paste0("Anzahl somatischer Mutationen (VAF > ", vaf, "%)"), "BRCAness", "Mikrosatelliten Status" ,"Anzahl CNV- Regionen"), Wert = c(as.character(sureselect_type), paste(covered_region, "Mb", sep = ""), paste0(round(x = filt_result_td$tmb, digits = 2), "/Mb"), round(x = sum(as.numeric(mutation_analysis_result$mut_tab[, 2])), digits = 0), "< 1.0%", as.character(filt_result_td$msi$MSI_status[1]), paste0(round(x = dim(cnv_analysis_results$cnvs_annotated$CNVsAnnotated)[1], digits = 0), " Regionen")))
#    }
#}
...
\begin{figure}[h]
\centering
  \subfloat[\"Ubersicht aller somatischen Mutationen]{\includegraphics[height = 0.3\textwidth]{\Sexpr{outfile_circos}}}\quad %
  \subfloat[\"Ubersicht aller CopyNumberVariations (CNVs)]{\includegraphics[height = 0.3\textwidth]{\Sexpr{cnv_ideogram_plot}}}
...
if (round(x = sum(stats$cover$cov[[2]][, 2] * stats$cover$cov[[2]][, 5]), digits = 2) < 80){
  q_t[1] <- "Akzeptabel"} else if (round(x = sum(stats$cover$cov[[2]][, 2] * stats$cover$cov[[2]][, 5]), digits = 2) < 100){
    q_t[1] <- "Gut"
  } else {q_t[1] <- "Sehr gut"}
if (round(stats$cover$perc[[2]][1], digits = 2) * 100 > 90){
  q_t[2] <- "Sehr gut"
} else { q_t[2] <- "Akzeptabel"}
if (round(stats$cover$perc[[2]][2], digits = 2) * 100 > 90){
  q_t[3] <- "Sehr gut"
} else {q_t[3] <- "Akzeptabel"}
if (as.numeric(stats$avreads$tin) > 100){
  q_t[4] <- "Sehr gut"
} else {q_t[4] <- "Akzeptabel"}
if (as.numeric(stats$qc_check$gc_content[[2]]) >= 40 && as.numeric(stats$qc_check$gc_content[[2]]) <= 60){
  q_t[5] <- "Sehr gut"
} else {q_t[5] <- "Akzeptabel"}
if (round(stats$qc_check$mean_QC[[2]], digits = 2) > 30){
  q_t[6] <- "Sehr gut"
} else {q_t[6] <- "Akzeptabel"}
qp_t <- c(round(x = sum(stats$cover$cov[[2]][, 2] * stats$cover$cov[[2]][, 5]), digits = 2), paste0(round(stats$cover$perc[[2]][1], digits = 2) * 100 , "%"), paste0(round(stats$cover$perc[[2]][2], digits = 2) * 100 , "%"), as.numeric(stats$avreads$tin) , as.numeric(stats$qc_check$gc_content[[2]]), round(stats$qc_check$mean_QC[[2]], digits = 2))
names(qp_t) <- c("Mittlere Coverage", "Coverage > 8", "Coverage > 40", "Insertlänge", "GC-Anteil", "Mittlere Qualität")        
...
if (round(x = sum(stats$cover$cov[[1]][, 2] * stats$cover$cov[[1]][, 5]), digits = 2) < 80){
  q_n[1] <- "Akzeptabel"} else if (round(x = sum(stats$cover$cov[[1]][, 2] * stats$cover$cov[[1]][, 5]), digits = 2) < 100){
    q_n[1] <- "Gut"
  } else {q_n[1] <- "Sehr gut"}
...
if (as.numeric(stats$qc_check$gc_content[[1]]) >= 40 && as.numeric(stats$qc_check$gc_content[[1]]) <= 60){
  q_n[5] <- "Sehr gut"
} else {q_n[5] <- "Akzeptabel"}
if (round(stats$qc_check$mean_QC[[1]], digits = 2) > 30){
  q_n[6] <- "Sehr gut"
} else {q_n[6] <- "Akzeptabel"}
qp_n <- c(round(x = sum(stats$cover$cov[[1]][, 2] * stats$cover$cov[[1]][, 5]), digits = 2), paste0(round(stats$cover$perc[[1]][1], digits = 2) * 100 , "%"), paste0(round(stats$cover$perc[[1]][2], digits = 2) * 100, "%"), as.numeric(stats$avreads$gin) , as.numeric(stats$qc_check$gc_content[[1]]), round(stats$qc_check$mean_QC[[1]], digits = 2))
names(qp_n) <- c("Mittlere Coverage", "Coverage > 8", "Coverage > 40", "Insertlänge", "GC-Anteil", "Mittlere Qualität")        
if(length(which(q_n != "Sehr gut") > 0)){
  warn_n <- paste0(names(qp_n)[which(q_n != "Sehr gut")], ": ", qp_n[which(q_n != "Sehr gut")])
...
In der Analyse werden nur seltene Mutationen mit einer \textit{Variant Allele Frequency} (VAF) über \Sexpr{vaf}\% betrachtet. Gezeigt werden Mutationen vom Typ \textit{single nucleotide variation} (SNV), \textit{Insertion and Deletions} (InDel) und \textit{Loss of Heterozygosity} (LoH). Letztere sind Mutationen, die in der Keimbahn heterozygot vorliegen, im Tumor allerdings homozygot.\\
...
\ifthenelse{\equal{\detokenize{\Sexpr{nchar(actionable_genes) > 0}}}{\detokenize{TRUE}}}{Die Keimbahnmutationen sind gemäß der Empfehlungen des American College of Medical Genetics für Zusatzbefunde bei Exom- und Genom-Untersuchungen (ACMG SF v2.0, PubMed 27854360) gefiltert, sodass nur Gene berichtet werden, aus deren Veränderung sich gezielt therapeutische oder präventive Maßnahmen ableiten lassen.}{}
...
Untersucht werden die Mutationssignaturen basierend auf den COSMIC Mutation Signatures (V2) für alle somatischen Mutationen in der Probe. In der folgenden Tabelle \ref{mut_sig} werden nur Signaturen gelistet, die einen Anteil größer als 1\% haben. In der Tabelle sind außer dem Anteil auch noch die Konfidenzintervalle (KI) angegeben. Die Signatur AC3 wird als \textit{BRCAness} bezeichnet.\\
...
if(dim(cnv_analysis_results$cnv_analysis_results$gain_go)[1] >= 20){
  ...
  tmp$`p-value` <- format(tmp$`p-value`,digits=3, scientific = TRUE)
  tmp$adj.P.Val <- format(tmp$adj.P.Val,digits=3, scientific = TRUE)
  kable(tmp, caption = "Ergebnisse Hallmarks Analsye - GAIN, top 20\\label{hm_CNV_loss}", booktabs = T, longtable = T, row.names = F) %>% kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 9) %>% column_spec(1, width = "15em") %>% column_spec(c(2:5), width = "5em")
  } else {
  ...
  tmp$`p-value` <- format(tmp$`p-value`,digits=3, scientific = TRUE)
  tmp$adj.P.Val <- format(tmp$adj.P.Val,digits=3, scientific = TRUE)
  kable(tmp, caption = "Ergebnisse Hllmarks Analsye - GAIN, top 20\\label{hm_CNV_loss}", booktabs = T, longtable = T, row.names = F) %>% kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 9) %>% column_spec(1, width = "15em") %>% column_spec(c(2:5), width = "5em")
}
@
...
\begin{table}[h]
  ...
  \hline Gewebe & Tumor & Keimbahn & Soll \\\hline
  Mittlere Coverage & \Sexpr{round(x = sum(stats$cover$cov[[2]][, 2] * stats$cover$cov[[2]][, 5]), digits = 2)} Reads & \Sexpr{round(x = sum(stats$cover$cov[[1]][, 2] * stats$cover$cov[[1]][, 5]), digits = 2)} Reads & Sehr gut >100, gut: 80-100 \\
  Anteil der Basen > 8 Reads & \Sexpr{round(stats$cover$perc[[2]][1], digits = 2) * 100} \% &  \Sexpr{round(stats$cover$perc[[1]][1], digits = 2) * 100} \% & >90\% \\
  Anteil der Basen > 40 Reads & \Sexpr{round(stats$cover$perc[[2]][2], digits = 2) * 100} \% & \Sexpr{round(stats$cover$perc[[1]][2], digits = 2) * 100} \% & Sehr gut: >90\%, akzeptabel: >60\% \\
  Anteil der exonischen Basen > 8 Reads & \Sexpr{round(stats$cover_exons$perc[[2]][1], digits = 2) * 100} \% &  \Sexpr{round(stats$cover_exons$perc[[1]][1], digits = 2) * 100} \% & >90\% \\
  Anteil der exonischen Basen > 40 Reads & \Sexpr{round(stats$cover_exons$perc[[2]][2], digits = 2) * 100} \% & \Sexpr{round(stats$cover_exons$perc[[1]][2], digits = 2) * 100} \% & Sehr gut: >90\%, akzeptabel: >60\% \\
  Insertgröße & \Sexpr{stats$avreads$tin} $\pm$  \Sexpr{stats$avreads$tin_sd}bp & \Sexpr{stats$avreads$gin} $\pm$  \Sexpr{stats$avreads$gin_sd} bp & >100 bp \\
  GC-Anteil & \Sexpr{stats$qc_check$gc_content[[2]]} \% & \Sexpr{stats$qc_check$gc_content[[1]]} \% & 40-60 \% \\
  Mittlere Qualität pro Base & \Sexpr{round(stats$qc_check$mean_QC[[2]], digits = 2) } & \Sexpr{round(stats$qc_check$mean_QC[[1]], digits = 2)} & > 0 \\\hline
...
<<eval=TRUE, results="tex", echo=FALSE>>=
if(dim(mutation_analysis_result$table_loh_mutations)[1] != 0){
  tmp <- mutation_analysis_result$table_loh_mutations[, c(1:8, 12, 13, 15, 17:21, 9:10)]
    tmp$AAChange <- gsub(pattern = "_", replacement = "\\_", x = tmp$AAChange, fixed = TRUE)
  # add a hyperlink to metaKB and one to GenomeNexus
  tmp$Gene.refGene_new <- paste0("{\\href{https://www.genomenexus.org/variant/", tmp$Chr, ":g.", tmp$Start, tmp$Ref, "\\%3E", tmp$Alt, "}{", tmp$Gene.refGene, "}}")
  id_del <- which(tmp$Alt == "-")
  ...
  tmp$Cancergene[which(tmp$is_oncogene == 1)] <- paste0("OG", tmp$Cancergene[which(tmp$is_oncogene == 1)])
  ihs <- which(tmp$is_hotspot != 0)
  tmp <- tmp[, c(1, 4, 3, 6, 5, 10, 11, 20, 21)]
  colnames(tmp) <- c("Gen", "AA-Austausch", "Funktion", "VAF (Coverage) Tumor", "VAF (Coverage) Keimbahn", "MAF", "Condel", "Cosmic", "Cancergene")
  if (dim(tmp)[1] != 0 & length(ihs) == 0){
    kable(tmp, format = "latex", caption = "Identifizierte Loss of Heterozygosity geordnet nach VAF in der Tumorprobe", booktabs = T, longtable = T, digits = 2, row.names = F, escape = FALSE) %>% kable_styling(latex_options = c( "HOLD_position", "repeat_header"), font_size = 9) %>% column_spec(c(8), width = "6em") %>% column_spec(c(1, 2), width = "5em") %>% column_spec(c(3:5), width = "3em") %>% column_spec(c(7), width = "2em") %>% row_spec(0, angle = 60)
  } else if (dim(tmp)[1] != 0 & length(ihs) != 0){
    kable(tmp, format = "latex", caption = "Identifizierte Loss of Heterozygosity geordnet nach VAF in der Tumorprobe", booktabs = T, longtable = T, digits = 2, row.names = F, escape = FALSE) %>% kable_styling(latex_options = c( "HOLD_position", "repeat_header"), font_size = 9) %>% column_spec(c(8), width = "6em") %>% column_spec(c(1, 2), width = "5em") %>% column_spec(c(3:5), width = "3em") %>% column_spec(c(7), width = "2em") %>% row_spec(0, angle = 60) %>% row_spec(ihs, bold = TRUE)
