...
readonly CFG_PANEL_SAMTOOLS_MPILEUP2SNP_MINFREQFORHOM=$(get_config_value panel.samtools.mpileup2snp.minFreqForHom "${PARAM_DIR_PATIENT}")
readonly CFG_PANEL_SAMTOOLS_MPILEUP2SNP_PVALUE=$(get_config_value panel.samtools.mpileup2snp.pValue "${PARAM_DIR_PATIENT}")
...
export CFG_PANEL_SAMTOOLS_MPILEUP2SNP_PVALUE
export CFG_PANEL_SAMTOOLS_MPILEUP2SNP_STRANDFILTER

export CFG_PANEL_SAMTOOLS_MPILEUP2INDEL_MINCOVERAGE
export CFG_PANEL_SAMTOOLS_MPILEUP2INDEL_MINREADS2
export CFG_PANEL_SAMTOOLS_MPILEUP2INDEL_MINFREQFORHOM
export CFG_PANEL_SAMTOOLS_MPILEUP2INDEL_PVALUE
export CFG_PANEL_SAMTOOLS_MPILEUP2INDEL_STRANDFILTER
